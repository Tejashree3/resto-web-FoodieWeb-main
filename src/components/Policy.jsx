  ...
  return (
   ...
   <div className=" min-h-screen   flex w-full items-center justify-start   pt-[35px] p-2 bg-white transform  max-w-screen-lg mx-auto">
          <div className="fadeIn w-full max-w-4xl p-6   ">
            <h1 className="text-4xl text-lightText font-bold mt-16 mb-8">Privacy Policy </h1>
            <h4 className="font-medium text-menu-color ">Welcome to </h4>
            <p className="my-4 mx-4 text-menu-color">
              Add some Privacy Policy here, for example "These Privacy Policy govern your use of Spangle and the Spangle applications, products and Policy that we offer (the Spangle Product or Products), except where we expressly state that separate Privacy Policy (and not these) apply."
              <br />
              <br />
              Would appreciate you visiting spangle.com.au to click around and help my SEO :)
            </p>
    
            <div className="PolicyLeadingSection my-4">
              <h4>
                <span className="text-2xl font-semibold text-backgroundColor">1.</span>
                <span className="text-2xl font-semibold text-backgroundColor">Our Policy</span>
              </h4>
              ...
              {Array.from({ length: 6 }).map((_, index) => (
                <div key={index} className="relative mb-4">
                  <h6 className="font-bold ml-4 mt-4 mb-2 text-yellow">Some Policy info</h6>
            ...
            {/* <h4 className="border-b-2 border-black mt-4 mb-4 pb-1 cursor-pointer">CLOSE Privacy Policy AND CONDITIONS</h4> */}
          </div>
        </div>
<Footer2/>
   </>
